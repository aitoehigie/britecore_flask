...
class Tag(compat.with_metaclass(_TagMeta, Node)):
    ...
    def __init__(
        self, keyword, attributes, expressions, nonexpressions, required, **kwargs
    ):
...
class IncludeTag(Tag):
    ...
    def __init__(self, keyword, attributes, **kwargs):
        super(IncludeTag, self).__init__(
            keyword, attributes, ("file", "import", "args"), (), ("file",), **kwargs
        )
...
class BlockTag(Tag):
    ...
    def __init__(self, keyword, attributes, **kwargs):
        ...
        if name and not re.match(r"^[\w_]+$", name):
            raise exceptions.CompileException(
                "%block may not specify an argument signature", **self.exception_kwargs
            )
