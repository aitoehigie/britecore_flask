...
from mako.compat import quote_plus, unquote_plus, codepoint2name, name2codepoint
...
class XMLEntityEscaper(object):
    def __init__(self, codepoint2name, name2codepoint):
        self.codepoint2entity = dict(
            [(c, compat.text_type("&%s;" % n)) for c, n in codepoint2name.items()]
        )
    ...
    def escape(self, text):
        ...
        """
        return self.__escapable.sub(self.__escape, compat.text_type(text)).encode(
            "ascii"
        )
