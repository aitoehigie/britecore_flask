...
class Group(object):
    ...
    def __init__(self, *options, **kwargs):
        ...
        if (self.title or self.description) and (self.required or self.exclusive):
            raise TypeError(
                "title and/or description cannot be used with "
...
class Server(Command):
    ...
    def get_options(self):
        ...
        options = (
            ...
            Option("--processes", dest="processes", type=int, default=self.processes),
            Option(
                "--passthrough-errors",
                action="store_true",
...
class ShowUrls(Command):
    ...
    def get_options(self):
        return (
            Option("url", nargs="?", help="Url to test (ex. /static/image.png)"),
            Option(
                "--order",
                dest="order",
                default=self.order,
