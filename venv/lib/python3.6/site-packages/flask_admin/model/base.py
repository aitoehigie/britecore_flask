...
from flask_admin._compat import (
    iteritems,
    itervalues,
    OrderedDict,
    as_unicode,
...
class BaseModelView(BaseView, ActionsMixin):
    ...
    column_exclude_list = ObsoleteAttr(
        "column_exclude_list", "excluded_list_columns", None
    )
    """
    ...
    column_type_formatters = ObsoleteAttr(
        "column_type_formatters", "list_type_formatters", None
    )
    """
    ...
    column_sortable_list = ObsoleteAttr(
        "column_sortable_list", "sortable_columns", None
    )
    """
    ...
    column_searchable_list = ObsoleteAttr(
        "column_searchable_list", "searchable_columns", None
    )
    """
    ...
    form_excluded_columns = ObsoleteAttr(
        "form_excluded_columns", "excluded_form_columns", None
    )
    """
    ...
    # Actions
    action_disallowed_list = ObsoleteAttr(
        "action_disallowed_list", "disallowed_actions", []
    )
    """
    ...
    def get_details_columns(self):
        ...
        return self.get_column_names(
            only_columns=only_columns, excluded_columns=self.column_details_exclude_list
        )
    ...
    def get_export_columns(self):
        ...
        return self.get_column_names(
            only_columns=only_columns, excluded_columns=self.column_export_exclude_list
        )
    ...
    def get_list_value(self, context, model, name):
        ...
        return self._get_list_value(
            context, model, name, self.column_formatters, self.column_type_formatters
        )
